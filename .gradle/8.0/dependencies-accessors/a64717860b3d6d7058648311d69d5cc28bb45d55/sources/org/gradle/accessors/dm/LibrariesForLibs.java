...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final TimberLibraryAccessors laccForTimberLibraryAccessors = new TimberLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at timber
     */
    public TimberLibraryAccessors getTimber() { return laccForTimberLibraryAccessors; }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        ...
        public ComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getHilt() { return create("compose.hilt"); }
         ...
         */
        public ComposeLifecycleLibraryAccessors getLifecycle() { return laccForComposeLifecycleLibraryAccessors; }
    ...
    public static class ComposeFoundationLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public ComposeFoundationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("compose.foundation"); }
    ...
    public static class ComposeLifecycleLibraryAccessors extends SubDependencyFactory {
        ...
        public ComposeLifecycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getRuntime() { return create("compose.lifecycle.runtime"); }
    ...
    public static class ComposeMaterialLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public ComposeMaterialLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getSize() { return create("compose.material.size"); }
    ...
    public static class ComposeRuntimeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public ComposeRuntimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("compose.runtime"); }

            /**
             * Creates a dependency provider for livedata (androidx.compose.runtime:runtime-livedata)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getLivedata() { return create("compose.runtime.livedata"); }
    ...
    public static class ComposeUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public ComposeUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getController() { return create("compose.ui.controller"); }
    ...
    public static class OkhttpLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public OkhttpLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for intercepter (com.squareup.okhttp3:logging-interceptor)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getIntercepter() { return create("okhttp.intercepter"); }
    ...
    public static class RoomLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public RoomLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for coroutine (androidx.room:room-coroutines)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCoroutine() { return create("room.coroutine"); }

            /**
             * Creates a dependency provider for ksp (androidx.room:room-compiler)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKsp() { return create("room.ksp"); }
    ...
    public static class TimberLibraryAccessors extends SubDependencyFactory {

        public TimberLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for log (com.jakewharton.timber:timber)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getLog() { return create("timber.log"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: material3 (1.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
         ...
         */
        public DaggerVersionAccessors getDagger() { return vaccForDaggerVersionAccessors; }
    ...
    public static class CoilVersionAccessors extends VersionFactory  {
        ...
        public CoilVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: coil.compose (2.4.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Returns the version associated to this alias: compose (1.5.1)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("compose"); }
            ...
            /**
             * Returns the version associated to this alias: compose.hilt (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getHilt() { return getVersion("compose.hilt"); }

            /**
             * Returns the version associated to this alias: compose.navigation (2.7.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class DaggerVersionAccessors extends VersionFactory  {
        ...
        public DaggerVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: dagger.hilt (2.48)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class LifecycleRuntimeVersionAccessors extends VersionFactory  {
        ...
        public LifecycleRuntimeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: lifecycle.runtime.compose (2.7.0-alpha02)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class MoshiVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("moshi"); }
            ...
            /**
             * Returns the version associated to this alias: moshi.converter (2.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getConverter() { return getVersion("moshi.converter"); }
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
         ...
         */
        public NavigationUiVersionAccessors getUi() { return vaccForNavigationUiVersionAccessors; }
    ...
    public static class NavigationUiVersionAccessors extends VersionFactory  {
        ...
        public NavigationUiVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: navigation.ui.ktx (2.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class DaggerPluginAccessors extends PluginFactory {
        ...
        public DaggerPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for dagger.compiler to the plugin id 'com.google.dagger.hilt.android'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompiler() { return createPlugin("dagger.compiler"); }
